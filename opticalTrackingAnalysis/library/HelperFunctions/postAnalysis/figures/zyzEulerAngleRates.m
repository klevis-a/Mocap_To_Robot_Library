function fig=zyzEulerAngleRates(figureNum, plotStyle, mocapTime, eulerRatesMocap, eulerRatesNdi, isVisible)
    ...
    legend('boxoff')
    title('Desired vs Achieved ZYZ Euler Angle Velocity');
end