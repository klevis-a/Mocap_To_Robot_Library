function fig=twYxzEulerAngleRates(figureNum, plotStyle, warpPathVel, eulerRatesMocap, eulerRatesNdi, isVisible)
    ...
    legend('boxoff')
    title('Time Warped Desired vs Achieved YXZ Euler Angle Velocity');
end