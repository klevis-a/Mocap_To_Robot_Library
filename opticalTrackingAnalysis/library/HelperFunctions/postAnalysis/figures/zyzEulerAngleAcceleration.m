function fig=zyzEulerAngleAcceleration(figureNum,plotStyle,mocapTime,eulerAccelerationMocap,eulerAccelerationNdi,isVisible)
    ...
    legend('boxoff')
    suptitle('Desired vs Achieved Euler Angle Acceleration (ZYZ)');
    if ~isVisible
        set(fig,'Visible','off');
    end
end