function fig=twYxzEulerAngleAcceleration(figureNum,plotStyle,warpPathAcc,eulerAccelerationMocap,eulerAccelerationNdi,isVisible)
    ...
    legend('boxoff')
    suptitle('Time Warped Desired vs Achieved Euler Angle Acceleration (YXZ)');
    if ~isVisible
        set(fig,'Visible','off');
    end
end